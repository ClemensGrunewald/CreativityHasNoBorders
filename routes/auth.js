...
router.post('/login', middleware.isAuthenticated, controller.process_login)

router.get('/register', middleware.isAuthenticated, controller.render_register)

router.post('/register', middleware.isAuthenticated, controller.process_register)
...
router.post('/password-reset', middleware.isAuthenticated, controller.process_password_reset)

router.get('/password-reset/:token', middleware.isAuthenticated, controller.render_password_reset_new)

router.post('/password-reset/:token', middleware.isAuthenticated, controller.process_password_reset_new)
